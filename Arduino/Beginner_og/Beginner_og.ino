...
void setup() 
{
 ...
 digitalWrite(7, LOW);
  ...
  // storage class initialized at this point
...
//  Serial.println(infoW.Wavelength[1]);
//  Serial.println(infoW.Wavelength[2]);
//    Serial.println(infoW.Wavelength[3]);

  // =============== spectrum acquisition ===============
  nsp32.AcqSpectrum(0, 64, 3, false);   // integration time = 32; frame avg num = 3; disable AE
//     Serial.println(F("Elements of wavelength = "));
//  Serial.println(infoW.Wavelength[0]);
//  Serial.println(infoW.Wavelength[1]);
//  Serial.println(infoW.Wavelength[2]);
...
//  }
  ...
  // write the line
  for (int i = 0; i< infoW.NumOfPoints; i++) {
//    Serial.print(infoS.Spectrum[i], 6);
//    Serial.print(',');
    line.concat(infoS.Spectrum[i]);
    line.concat(",");
  }
  write_to_sd(line);
  // wait 1 minute
